...
3. This is why using a RUN for a unique operation is more proper, each opeation on a different line. These are two "schools" but we prefer the second one :D !
